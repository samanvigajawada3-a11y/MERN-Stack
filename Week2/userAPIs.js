...
userApp.get('/users',(req,res)=>{ // /users - url path.
    // read all users and send to the client
    res.json({message : "all users",payload : users})
})

// Route to read user by id
userApp.get('/users/:id',(req,res)=>{ // /users - url path.
...
userApp.delete('/users/:id',(req,res)=>{ // The parameters that we send through the url will be string so, we need to convert it into number.
